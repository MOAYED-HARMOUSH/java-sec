...
public class PullMoney {
    ...
    public void pullMoney(PrintWriter writer, BufferedReader reader, PublicKey clientPublicKey, PrivateKey serverPrivateKey) throws Exception {
        String sessionID;
        ...
        if (userId != null) {
            ...
            writer.println( "ENCForpulMoney|" +java.util.Base64.getEncoder().encodeToString(encryptedChoice));
            ...
            if(balance>Integer.parseInt(decryptedChoice)){
